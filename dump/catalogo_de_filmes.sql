...
CREATE TABLE `detalhes` (
  `id` int(11) NOT NULL,
  `duracaodofilme` int(11) NOT NULL,
  `sinopse` text DEFAULT NULL,
  `orcamento` decimal(16,2) DEFAULT NULL,
  `bilheteria` decimal(16,0) DEFAULT NULL,
...
CREATE TABLE `generos` (
  `id` int(11) NOT NULL,
  `nomedogenero` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `detalhes`
  ADD CONSTRAINT `fk_detalhes_filmes` FOREIGN KEY (`filmes_id`) REFERENCES `filmes` (`id`);
